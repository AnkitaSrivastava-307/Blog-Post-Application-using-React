...
const options = ["Travel", "Fashion", "Animal", "Sports", "Food", "Tech"];
...
const AddEditBlog = () => {
    ...
    const onUploadImage = (file) => {
        ...
        formData.append("upload_preset", "idacajuw");
        axios.post("http://api.cloudinary.com/v1_1/dafa9c9su/image/upload", formData).then((resp) => {
